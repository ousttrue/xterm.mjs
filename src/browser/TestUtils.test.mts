...
import { IEvent, EventEmitter } from 'common/EventEmitter.mjs';
import { ICharacterJoinerService, ICharSizeService, ICoreBrowserService, IMouseService, IRenderService, ISelectionService, IThemeService } from 'browser/services/Services.mjs';
import { IRenderDimensions, IRenderer, IRequestRedrawEvent } from 'browser/renderer/shared/Types.mjs';
import { IColorSet, ITerminal, ILinkifier2, IBrowser, IViewport, ICompositionHelper, CharacterJoinerHandler, IBufferRange, ReadonlyColorSet, IBufferElementProvider } from 'browser/Types.mjs';
import { IBuffer, IBufferSet } from 'common/buffer/Types.mjs';
import { IBufferLine, ICellData, IAttributeData, ICircularList, XtermListener, ICharset, ITerminalOptions, ColorIndex } from 'common/Types.mjs';
import { Buffer } from 'common/buffer/Buffer.mjs';
import * as Browser from 'common/Platform.mjs';
import { Terminal } from 'browser/Terminal.mjs';
import { IUnicodeService, IOptionsService, ICoreService, ICoreMouseService } from 'common/services/Services.mjs';
import { IFunctionIdentifier, IParams } from 'common/parser/Types.mjs';
import { AttributeData } from 'common/buffer/AttributeData.mjs';
import { ISelectionRedrawRequestEvent, ISelectionRequestScrollLinesEvent } from 'browser/selection/Types.mjs';
import { css } from 'common/Color.mjs';
