...
import { copyHandler, handlePasteEvent, moveTextAreaUnderMouseCursor, paste, rightClickHandler } from 'browser/Clipboard.mjs';
import { addDisposableDomListener } from 'browser/Lifecycle.mjs';
import { Linkifier2 } from 'browser/Linkifier2.mjs';
import * as Strings from 'browser/LocalizableStrings.mjs';
import { OscLinkProvider } from 'browser/OscLinkProvider.mjs';
import { CharacterJoinerHandler, CustomKeyEventHandler, IBrowser, IBufferRange, ICompositionHelper, ILinkifier2, ITerminal, IViewport } from 'browser/Types.mjs';
import { Viewport } from 'browser/Viewport.mjs';
import { BufferDecorationRenderer } from 'browser/decorations/BufferDecorationRenderer.mjs';
import { OverviewRulerRenderer } from 'browser/decorations/OverviewRulerRenderer.mjs';
import { CompositionHelper } from 'browser/input/CompositionHelper.mjs';
import { DomRenderer } from 'browser/renderer/dom/DomRenderer.mjs';
import { IRenderer } from 'browser/renderer/shared/Types.mjs';
import { CharSizeService } from 'browser/services/CharSizeService.mjs';
import { CharacterJoinerService } from 'browser/services/CharacterJoinerService.mjs';
import { CoreBrowserService } from 'browser/services/CoreBrowserService.mjs';
import { MouseService } from 'browser/services/MouseService.mjs';
import { RenderService } from 'browser/services/RenderService.mjs';
import { SelectionService } from 'browser/services/SelectionService.mjs';
import { ICharSizeService, ICharacterJoinerService, ICoreBrowserService, IMouseService, IRenderService, ISelectionService, IThemeService } from 'browser/services/Services.mjs';
import { ThemeService } from 'browser/services/ThemeService.mjs';
import { color, rgba } from 'common/Color.mjs';
import { CoreTerminal } from 'common/CoreTerminal.mjs';
import { EventEmitter, IEvent, forwardEvent } from 'common/EventEmitter.mjs';
import { MutableDisposable, toDisposable } from 'common/Lifecycle.mjs';
import * as Browser from 'common/Platform.mjs';
import { ColorRequestType, CoreMouseAction, CoreMouseButton, CoreMouseEventType, IColorEvent, ITerminalOptions, KeyboardResultType, ScrollSource, SpecialColorIndex } from 'common/Types.mjs';
import { DEFAULT_ATTR_DATA } from 'common/buffer/BufferLine.mjs';
import { IBuffer } from 'common/buffer/Types.mjs';
import { C0, C1_ESCAPED } from 'common/data/EscapeSequences.mjs';
import { evaluateKeyboardEvent } from 'common/input/Keyboard.mjs';
import { toRgbString } from 'common/input/XParseColor.mjs';
import { DecorationService } from 'common/services/DecorationService.mjs';
import { IDecorationService } from 'common/services/Services.mjs';
import { IDecoration, IDecorationOptions, IDisposable, ILinkProvider, IMarker } from 'xterm';
import { WindowsOptionsReportType } from '../common/InputHandler.mjs';
