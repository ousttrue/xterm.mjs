 ...
 * @license MIT
 */
import { NULL_CELL_CHAR, NULL_CELL_WIDTH, NULL_CELL_CODE, DEFAULT_ATTR, Content, UnderlineStyle, BgFlags, Attributes, FgFlags } from 'common/buffer/Constants.mjs';
import { BufferLine } from 'common/buffer//BufferLine.mjs';
import { CellData } from 'common/buffer/CellData.mjs';
import { CharData, IBufferLine } from '../Types.mjs';
