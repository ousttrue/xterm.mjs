...
import { IInputHandler, IAttributeData, IDisposable, IWindowOptions, IColorEvent, IParseStack, ColorIndex, ColorRequestType, SpecialColorIndex } from 'common/Types.mjs';
import { C0, C1 } from 'common/data/EscapeSequences.mjs';
import { CHARSETS, DEFAULT_CHARSET } from 'common/data/Charsets.mjs';
import { EscapeSequenceParser } from 'common/parser/EscapeSequenceParser.mjs';
import { Disposable } from 'common/Lifecycle.mjs';
import { StringToUtf32, stringFromCodePoint, Utf8ToUtf32 } from 'common/input/TextDecoder.mjs';
import { BufferLine, DEFAULT_ATTR_DATA } from 'common/buffer/BufferLine.mjs';
import { EventEmitter } from 'common/EventEmitter.mjs';
import { IParsingState, IEscapeSequenceParser, IParams, IFunctionIdentifier } from 'common/parser/Types.mjs';
import { NULL_CELL_CODE, NULL_CELL_WIDTH, Attributes, FgFlags, BgFlags, Content, UnderlineStyle } from 'common/buffer/Constants.mjs';
import { CellData } from 'common/buffer/CellData.mjs';
import { AttributeData } from 'common/buffer/AttributeData.mjs';
import { ICoreService, IBufferService, IOptionsService, ILogService, ICoreMouseService, ICharsetService, IUnicodeService, LogLevelEnum, IOscLinkService } from 'common/services/Services.mjs';
import { UnicodeService } from 'common/services/UnicodeService.mjs';
import { OscHandler } from 'common/parser/OscParser.mjs';
import { DcsHandler } from 'common/parser/DcsParser.mjs';
import { IBuffer } from 'common/buffer/Types.mjs';
import { parseColor } from 'common/input/XParseColor.mjs';
