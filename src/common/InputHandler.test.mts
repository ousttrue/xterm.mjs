...
import { IBufferLine, IAttributeData, IColorEvent, ColorIndex, ColorRequestType, SpecialColorIndex } from 'common/Types.mjs';
import { DEFAULT_ATTR_DATA } from 'common/buffer/BufferLine.mjs';
import { CellData } from 'common/buffer/CellData.mjs';
import { Attributes, BgFlags, UnderlineStyle } from 'common/buffer/Constants.mjs';
import { AttributeData, ExtendedAttrs } from 'common/buffer/AttributeData.mjs';
import { Params } from 'common/parser/Params.mjs';
import { MockCoreService, MockBufferService, MockOptionsService, MockLogService, MockCoreMouseService, MockCharsetService, MockUnicodeService, MockOscLinkService } from 'common/TestUtils.test.mjs';
import { IBufferService, ICoreService } from 'common/services/Services.mjs';
import { DEFAULT_OPTIONS } from 'common/services/OptionsService.mjs';
import { clone } from 'common/Clone.mjs';
import { BufferService } from 'common/services/BufferService.mjs';
