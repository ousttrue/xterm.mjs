...
import { IBufferService, ICoreService, ILogService, IOptionsService, ITerminalOptions, ICoreMouseService, ICharsetService, UnicodeCharProperties, UnicodeCharWidth, IUnicodeService, IUnicodeVersionProvider, LogLevelEnum, IDecorationService, IInternalDecoration, IOscLinkService } from 'common/services/Services.mjs';
...
import { IBufferSet, IBuffer } from 'common/buffer/Types.mjs';
import { BufferSet } from 'common/buffer/BufferSet.mjs';
import { IDecPrivateModes, ICoreMouseEvent, CoreMouseEventType, ICharset, IModes, IAttributeData, IOscLinkData, IDisposable } from 'common/Types.mjs';
import { UnicodeV6 } from 'common/input/UnicodeV6.mjs';
